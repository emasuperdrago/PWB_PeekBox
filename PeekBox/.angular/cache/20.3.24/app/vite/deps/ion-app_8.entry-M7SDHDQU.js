...
} from "./chunk-EZSM34CM.js";
import {
  transition
} from "./chunk-OMX2LGUE.js";
import {
  clamp,
  componentOnReady,
  hasLazyBuild,
  ...
  componentDidLoad() {
    {
      this.rIC(() => __async(this, null, function* () {
        ...
        if (!config.getBoolean("_testing")) {
          import("./index-BtUdxPjv-32WIUUAW.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./status-tap-BfJqFSLF-4JBQGQNG.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./input-shims-AaDhOpKN-6H64CR3I.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = yield import("./hardware-back-button-CTe4XmL7-36PYZ6JI.js");
        ...
        if (typeof window !== "undefined") {
          import("./keyboard-ywgs5efA-HF6HLDON.js").then((module) => module.startKeyboardAssist(window));
        }
        import("./focus-visible-BmVRXR1y-ZSSLCMYG.js").then((module) => this.focusVisible = module.startFocusVisible());
      }));
    }
  }
...
var RouterOutlet = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./swipe-back-BZBFwTQV-BTIYN2RP.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
        var _a;
...
//# sourceMappingURL=ion-app_8.entry-M7SDHDQU.js.map
