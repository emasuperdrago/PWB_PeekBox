  ...
  if (!n || !BUILD.hotModuleReplacement) {
    ...
    switch (a) {
      case "pwa-action-sheet":
        return import("./pwa-action-sheet.entry-ESHWABNK.js").then(s, consoleError);
      case "pwa-camera-modal":
        return import("./pwa-camera-modal.entry-M3Q5FITN.js").then(s, consoleError);
      case "pwa-toast":
        return import("./pwa-toast.entry-ZISUHMUV.js").then(s, consoleError);
      case "pwa-camera-modal-instance":
        return import("./pwa-camera-modal-instance.entry-2MNLPTA5.js").then(s, consoleError);
      case "pwa-camera":
        return import("./pwa-camera.entry-O32TQEQM.js").then(s, consoleError);
    }
  }
...
//# sourceMappingURL=chunk-EQIOVYJP.js.map
